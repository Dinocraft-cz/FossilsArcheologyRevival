        ...
        for (i3 = 0; i3 < 4; ++i3) {
            for (j3 = 0; j3 < 4; ++j3) {
                for (k3 = -1; k3 < 4; ++k3) {
                    ...
                    this.worldServerInstance.setBlock(l3, i4, j4, flag ? Blocks.obsidian : Blocks.portal, 0, 2);
                }
            }
    ...
    public void removeStalePortalLocations(long p_85189_1_) {
        if (p_85189_1_ % 100L == 0L) {
            ...
            while (iterator.hasNext()) {
                ...
                AnuTeleporter.PortalPosition portalposition = (AnuTeleporter.PortalPosition) this.destinationCoordinateCache.getValueByKey(olong);
